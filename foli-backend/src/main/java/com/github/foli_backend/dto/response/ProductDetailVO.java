...
/**
 * 商品详情视图对象 Product detail view object
 * 与 ProductVO 字段相同，但 storeName、categoryName、images 均已填充
 * Same fields as ProductVO, but storeName, categoryName, images are guaranteed populated
 */
@Schema(description = "商品详情视图 Product detail view")
